##'@param param.ci Parameter confidence intervals from uncertainty_anal
##'@param out.mat2 Model predictions at t = 1-16
...
<<<<<<< HEAD
  ...
  for(r in 1:5) {
    ...
    plot(t1, bp.ci[2,], xlim=c(1988, 2016), ylim=c(0, 1.1),
         xlab="year", ylab="percent bleaching", main=loc[r])
...
>>>>>>> cbb6a7204fee2aee802368515f6670c0b9a9705b
